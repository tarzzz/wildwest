...
```
.database/
├── software-engineer-request-{name}/
│   └── instructions.md         # Initial instructions for this engineer
└── intern-request-{name}/
    └── instructions.md         # Initial instructions for this intern
```
...
```
.database/
├── engineering-manager-1234567890/
│   ├── session.json
│   ├── tasks.md
│   ├── instructions.md
│   ├── tracker.json
│   └── persona-instructions.md  # Generated by orchestrator
├── software-engineer-1234567891/
└── intern-1234567892/
```
...
```
.database/
└── software-engineer-1234567891-completed/
    └── (all files preserved)
```
...
```
Request → Create Session → Spawn Claude → Monitor → Complete → Archive
```
...
#### From Manager/Architect → Request Engineer
...
🚀 Spawning engineering-manager: manager
   ✅ Session: engineering-manager-1706012345678 (PID: 12345)

🚀 Spawning solutions-architect: architect
...
```
🚀 Spawning software-engineer: backend-api
...
Orchestrator spawns:
```
🚀 Spawning intern: api-tester
   ✅ Session: intern-1706012345681 (PID: 12348)
```
...
```
🎉 All tasks completed for backend-api (software-engineer-1706012345680)
...
```
🚀 Spawning software-engineer: api-developer
   ✅ Session: software-engineer-1706012345680 (PID: 12347)

⚠️  Process for intern-1706012345681 has exited

🎉 All tasks completed for api-developer (software-engineer-1706012345680)
   📦 Archived to: software-engineer-1706012345680-completed

✅ Session software-engineer-1706012345680 completed successfully
```
