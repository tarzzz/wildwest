...
When your testing is DONE, you MUST report to Leader:
  ...
  I am now available for new assignments.
  EOF
Your Persona Directory: qa-1769794302075/
Your Role: /Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075
...
- Your persona-specific files are in: deming/
- Reference your persona files using the full path above

## Files in Your Persona Directory
- /Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075/tasks.md: YOUR task list (you update this)
- /Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075/instructions.md: Instructions from others (read regularly)
- /Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075/tracker.json: Reading state tracker (automatic)
- /Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075/persona-instructions.md: Your role and capabilities
...
### Update Your Tasks
- Update /Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075/tasks.md with your progress after completing work
...
- Your persona directory (/Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075/) is only for instructions/tasks tracking

%!(EXTRA string=/Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075)
## Communicating with Other Agents
...
## Instructions from deming ($(date '+%Y-%m-%d %H:%M:%S'))
...
Bash(PERSONA_DIR=/Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075; while true; do CURRENT=$(grep '^## Task:' $PERSONA_DIR/tasks.md 2>/dev/null | head -1 | sed 's/^## Task: //' || echo "No tasks assigned"); jq --arg status "$CURRENT" '.current_work = $status' $PERSONA_DIR/session.json > $PERSONA_DIR/session.tmp && mv $PERSONA_DIR/session.tmp $PERSONA_DIR/session.json; sleep 10; done, run_in_background=true)
...
3. Begin working on your tasks from /Users/tarun/plotly/wildwest/.ww-db/8d104ad0/qa-1769794302075/tasks.md
